...
\AtBeginSubsection[]{
  \begin{frame}<trans|beamer>[shrink=10]{小節目次}
...
\mode<presentation>{\renewcommand{\imageheight}{0.4\textheight}}
\transfade<2->[duration=0.1]
\begin{columns}
\begin{column}{0.5\textwidth}
\[ ax^2+bx+c = 0 \]
...
\item 収集した情報を分析し、操作履歴（OP, Operation Profile）に整理
\item 操作履歴によってテストを行い
