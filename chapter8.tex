...
\pgfdeclareimage[height=0.5cm]{logo}{figure/Osaka_University_logo.pdf}
...
\pgfdeclareimage[height=0.5\textheight]{Ad-Hoc-Testing}{figure/Ad-Hoc-Testing.jpg}
\pgfdeclareimage[height=0.5\textheight]{Random-Testing}{figure/Random-Testing.jpg}
